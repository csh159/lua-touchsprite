	...
	if abl()then
		if get_idfa(bid_app)then
			...
			if vpn_key or VPN()then
				...
				toast(ip_address,1)
				if ip_address then
					if GetTask("helm",adid,idfa)then
						toast('排重成功',1)
						up ={}
						up.mail = idfa
...
--[[
http://apiyoumi.kdatm.com/show/query/idfa_tuniu.php?bid=helm&idfa=DD4AD0C4-91F2-4106-BF7C-5AC563DDC2C3&source=sz&adid=10105&ip=192.168.5.6
--]]
