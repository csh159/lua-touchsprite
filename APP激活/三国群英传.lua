...
--[[
http://apiyoumi.kdatm.com/show/query/idfa_tuniu.php?bid=sgqyz&idfa=DD4AD0C4-91F2-4106-BF7C-5AC563DDC1C9&source=sz&adid=10086&ip=192.168.5.6.
--]]

if xz(bid_app)then
while (true) do
	if upidfa('sgqyz')then
