...
function upidfa()
	...
	if abl()then
		...
		if VPN()then
			...
			if ip_address then
				if GetTask('nowzp',adid,idfa)then
					toast('排重成功',1)
					up ={}
					up.mail = idfa
					up.fristname = app_name
...
--[[
回调任务：
http://apiyoumi.kdatm.com/show/query/idfa_tuniu.php?bid=nowzp&idfa=DD4AD0C4-91F2-4106-BF7C-5AC563DDC2C3&source=sz&adid=10069&ip=192.168.5.6
产品名称：NOW直播   
--]]
