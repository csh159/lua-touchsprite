...
aoc={{418,965,0xf23030},{113,961,0xffffff},}
...
app_url = 'https://itunes.apple.com/cn/app/id414603431?mt=8'

--[[
回调任务
http://apiyoumi.kdatm.com/show/query/idfa_tuniu.php?
bid=zmhjz&idfa=DD4AD0C4-91F2-4106-BF7C-5AC563DDC1C9&source=sz&adid=10068&ip=192.168.5.6&os= 

产品链接：https://itunes.apple.com/cn/app/id1288910541?mt=8
--]]

if xz(bid_app)then
	while (true) do
		if upidfa('zmhjz')then
