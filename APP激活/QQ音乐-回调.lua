...
bid=qqmusic&idfa=DD4AD0C4-91F2-4106-BF7C-5AC563DDC1C9&source=sz&adid=10069&ip=192.168.5.6
产品:qq音乐
https://itunes.apple.com/cn/app/id414603431?mt=8
--]]

if xz(bid_app)then
	while (true) do
		if upidfa('qqmusic')then
