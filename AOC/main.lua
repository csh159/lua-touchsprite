...
aoc['在地图中']={}
	aoc['在地图中']['在地图界面']={{1222,32,0x9b5500},{308,674,0x4ac3f7},{207,701,0xffcc01},{69,677,0xd2ff14},}
	--1商城,2领地,3地图,4任务
...
aoc['返回']={}
	aoc['返回']['返回图标']={{36,29,0xf0ef90}}
		...
		aoc['返回']['商城界面']={{41,25,0xf6f592},{1128,34,0xf4e229},{1128,25,0x02c9a2},}
		...
		aoc['返回']['设置']={{191,26,0x0b131d},{191,27,0xfdfdfd},{161,23,0x0f1720},{161,18,0xffffff},}
			...
			aoc['返回']['礼包红点']={ 0xcc0424, "2|-20|0xcc0424,10|-25|0xfffe5c", 90, 1098, 52, 1319, 741}
				aoc['返回']['奖励确定']={ 0xffffff, "3|-9|0x104a5a,17|-47|0x5dc2e1,8|44|0x2feac1", 80, 380, 80, 560, 722}
...
aoc['换服']={}
	aoc['换服']['在地图上']={{1222,35,0x9a5100},{223,699,0xe70100},{65,688,0xdeff28},}
...
aoc['战斗']={}
	...
	aoc['战斗']['英勇跳跃']={ 0xfffdb2, "0|-30|0xcc3306,-6|-64|0xcc2209,-35|-28|0xcc2207", 80, 399, 578, 1068, 733}
...
aoc['新手']['战斗界面中']={{63,13,0x2d6577},{46,34,0x194c46},{53,27,0x184242},{58,25,0xe9e68d},}
	...
	aoc['新手']['寻找英雄']={ 0x443311, 
			"2|0|0xffdd77,46|0|0xeebb44,47|0|0x443311", 90, 116, 11, 1319, 739}
...
aoc['other']={}
	...
	aoc['other']['直接扫荡']={{371,477,0x0023e1},{375,472,0xe2f6fc},{837,503,0x8fef44},}
...
while (true) do
	...
	if 主线 < 6 and 轮回 >= tonumber(values.game_mun) then
		toast('完成一轮', 5)
		轮回 = 0
		主线 = 主线 + 1
		if 主线 > 6 then
