...
aoc['在地图中']={}
	aoc['在地图中']['在地图界面']={{1222,33,0x9a5200}, {307,660,0x3f5cad}, {180,670,0x927345}, {65,682,0xe3ff32}, }
	--1商城,2领地,3地图,4任务
...
function other()
	...
	elseif UI('other','启动画面',false,1)then
		...
		if other_click_mun%10 ==0 then
			click(h/2,w/2)
		elseif other_click_mun%5 == 0 then
			click(40,40)
		end
	end
...
aoc['返回']['研究院界面']={ 0xfffcff, "0|3|0x2d956c,48|515|0xfffdfe,45|513|0x08715b", 90, 427, 89, 933, 721}
...
--delay(2)
----UI('新手','战斗界面中_新手',false,1)
--UI_pic('城堡','非主城建筑',false)
--UI_pic('城堡','主城建筑',false)
--lua_exit()
