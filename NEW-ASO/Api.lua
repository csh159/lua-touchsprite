...
function upPhone(t)
	...
	service = "http://store.zhangdabei.com:3000/api/upload_phone"
...
function GetTask()
	...
	get_task_url = 'http://store.zhangdabei.com:3000/api/get_task?phone_uid='..iphoneId..'&secret='..secret
	local sz = require("sz")
...
function upTask(t)
	...
	safari = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.111 Safari/537.36'
	service = "http://store.zhangdabei.com:3000/api/upload_task"
...
function upAccount(t)
	...
	safari = 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.111 Safari/537.36'
	service = "http://store.zhangdabei.com:3000/api/update_account"
