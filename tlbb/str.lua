...
aoc['切号']['菜单激活']={{1086,341,0xffffff},{1086,356,0xffffff},{1101,356,0xffffff},}
	aoc['切号']['菜单设置']={ 0xffeb90, "1|4|0xaa761f,-18|13|0xfbd267,-18|16|0x3c1500,-16|18|0xffcc31,-4|-17|0xffef90", 90, 825, 397, 1128, 628}
	...
	aoc['切号']['强化']={ 0xebefe7, "0|-14|0x513020,-14|14|0xf7d256,-10|21|0xf9f7dc,19|17|0xd86d26", 90, 815, 375, 1132, 630}
...
-------------------背包按钮----------
		aoc['游戏']['游戏主界面-背包按钮']={0xedda77, "3|4|0x702804", 90, 979, 335, 1030, 369}
-------------------活动开关---------
...
function event()
	if done(aoc['弹窗']['提示确定'],'提示确定',true,1)then
